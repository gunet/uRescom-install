...
* `URESCOM_SITE`: Θα πρέπει να είναι το FQDN του uRescom site
...
Κατά την πρώτη χρήση του περιβάλλοντος θα πρέπει στην αρχική οθόνη να εκτελεστεί η `Διαδικασία επικαιροποίησης`. Μετά την επιτυχή εκτέλεση της μπορούν να αναζητηθούν "πρόσφατοι" συμβασιούχοι μέσω του tab `Νέοι συμβασιούχοι`. Μπορεί να επιλεχθεί κάποιο από αυτά για να προστεθεί loginName.
