...
### Πρόσβαση σε βάση δεδομένων Rescom
Απαιτείται πρόσβαση ανάνγωσης στους ακόλουθους πίνακες της βάσης δεδομένων Rescom:
```
[Αποδέκτες]
[Symbaseis]
[Πρόσωπα_Φυσικά]
[Αποδεκτών_Διευθύνσεις]
[Αποδεκτών_Τηλέφωνα]
[Αποδεκτών_Διευθύνσεις_Ηλεκτρονικές]
[Χώρες]
```
