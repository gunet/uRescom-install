...
**Σημαντική σημείωση**: Η υπηρεσία παρέχεται σε μορφή **beta** για τον μήνα Δεκέμβριο με τη διασύνδεση του πίνακα `v_vd_hrms` με το GUNet IDM **δεν** να μην έχει υλοποιηθεί ακόμα πλήρως. Σε αυτή τη φάση ο κύριος στόχος είναι να συγκεντρωθούν παρατηρήσεις και σχόλια από τα ιδρύματα προκειμένου να ενσωματωθούν στην τελική έκδοση του περιβάλλοντος.
