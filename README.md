- [uRescom -- Γέφυρα για διασύνδεση του Rescom με το Identity management](#urescom----γέφυρα-για-διασύνδεση-του-rescom-με-το-identity-management)
  - [Βασικά Στοιχεία](#βασικά-στοιχεία)
    - [Τι κάνει το uRescom;](#τι-κάνει-το-urescom)
    - [Πώς γίνεται η εκτέλεση;](#πώς-γίνεται-η-εκτέλεση)
  - [FAQ](#faq)
    - [Καταλήγουν όλοι οι συμβασιούχοι που υπάρχουν στο Rescom στον v\_vd\_hrms;](#καταλήγουν-όλοι-οι-συμβασιούχοι-που-υπάρχουν-στο-rescom-στον-v_vd_hrms)
    - [Ποιες εγγραφές συμβασιούχων καταλήγουν στον v\_vd\_hrms;](#ποιες-εγγραφές-συμβασιούχων-καταλήγουν-στον-v_vd_hrms)
  - [Αρχιτεκτονική Εγκατάστασης](#αρχιτεκτονική-εγκατάστασης)
    - [Γενικές Πληροφορίες](#γενικές-πληροφορίες)
  - [Εγκατάσταση](#εγκατάσταση)
    - [Φάκελος certs](#φάκελος-certs)
    - [Φάκελος config](#φάκελος-config)
    - [urescom\_admin.sh](#urescom_adminsh)
    - [Δοκιμαστικό περιβάλλον](#δοκιμαστικό-περιβάλλον)
  - [Ανάγκες υλικού](#ανάγκες-υλικού)
    - [Βασική υπηρεσία](#βασική-υπηρεσία)
    - [Δοκιμαστικό περιβάλλον](#δοκιμαστικό-περιβάλλον-1)
